"""Figure 6: national public-security expenditure by government level."""
...
CONFIG = {
    ...
    "output_stem": "fig_06_seguranca_publica",
    "data_file": FIGURE_DATA_DIR / "fig_06_public_security.csv",
    "title": "Figura 6. Brasil: gastos com segurança pública",
...
def prepare_data() -> list[dict[str, str]]:
    ...
    if max(int(row["ano"]) for row in loaded) != ano_final:
        raise AssertionError("Terminal year changed during Figure 6 CSV round-trip.")
    return loaded
