"""Figure 6: formal and informal private-security costs."""
...
CONFIG = {
    ...
    "output_stem": "fig_06_seguranca_privada",
    "data_file": FIGURE_DATA_DIR / "fig_06_private_security.csv",
    "title": "Brasil: gastos com segurança privada",
